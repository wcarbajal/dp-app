...
export const usuarioSchema = z.object( {
  ...
  rol: z.int().min( 0, "El rol es obligatorio" ),  
  password: z.string().min( 6, "La contraseña debe tener al menos 6 caracteres" ).max( 100, "La contraseña no puede exceder los 100 caracteres" ).optional().or(z.literal("")),
